...
RegisterNetEvent('mero_npcmechanic:startRepair')
AddEventHandler('mero_npcmechanic:startRepair', function(index, vehicle)
    --Check if far away
...
RegisterNetEvent('mero_npcmechanic:startClean')
AddEventHandler('mero_npcmechanic:startClean', function(index, vehicle)
    --Check if far away
    if #(GetEntityCoords(PlayerPedId()) - Config.Locations[index].VehiclePoint) < 400 then
        isBusy[index] = true
        local vehicle = NetworkGetEntityFromNetworkId(vehicle)
...
RegisterNetEvent('mero_npcmechanic:end')
AddEventHandler('mero_npcmechanic:end', function(index)
        ...
        options = {
            {
                ...
                onSelect = function(args)
                    ...
                    ESX.TriggerServerCallback('mero_npcmechanic:pay', function(success) 
                        if success then
